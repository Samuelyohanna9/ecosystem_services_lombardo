...
const style = {
  ...
  // share payload uses current selection
  setupShareButtons(() => {
  ...
  map.on("load", async ()=>{
    ...
    ctx.fillStyle="#22c55e"; ctx.shadowColor="rgba(0,0,0,.18)"; ctx.shadowBlur=4;
    ctx.fill(); ctx.shadowBlur=0;
    ctx.fillStyle="#6b4f2a"; ctx.fillRect(ICON*0.47, ICON*0.46, ICON*0.06, ICON*0.26);
    ctx.beginPath(); ctx.ellipse(ICON*0.5, ICON*0.78, ICON*0.22, ICON*0.09, 0, 0, Math.PI*2);
